...
#include "yh_tutorial_6/yh_srv_6.h"  // 서비스 해더 파일 // 빌드 후 생성
...
int main(int argc, char** argv)// 메인 함수
{
    ...
    ros::ServiceClient yh_client_6 = nh.serviceClient<yh_tutorial_6::yh_srv_6>("yh_service_6");
