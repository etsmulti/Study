...
class FaceDetector():
    def __init__(self):
        ...
        credentials = ServiceAccountCredentials.from_json_keyfile_name(
                        'C:/Users/501/Documents/face_detection/absolute-bot-349403-2c2cd8e1e14e.json', scopes=scopes)
    ...
    # output 폴더도 input폴더(input data image folder)처럼 나눠서 저장
...
def main(argv):
    ...
    # desdir = argv[2]
    # maxnum = int(argv[3])  
    srcdir= 'C:/Users/501/Documents/face_detection/undetected_2'
    desdir = 'C:/Users/501/Documents/face_detection/detected_2'
    maxnum = 1000
